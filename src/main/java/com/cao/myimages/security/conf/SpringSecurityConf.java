package com.cao.myimages.security.conf;

import com.cao.myimages.security.Handler.*;
...
public class SpringSecurityConf extends WebSecurityConfigurerAdapter {
    @Resource
    AuthenticationEntryPoint authenticationEnryPoint;    //未登录
    @Resource
...
//    SessionInformationExpiredStrategy sessionInformationExpiredStrategy;    //检测异地登录
    ...
    private UserAuthenticationFilter UserAuthenticationFilterBean() throws Exception {
        ...
        userAuthenticationFilter.setAuthenticationSuccessHandler(authenticationSuccess);
 ...
 //               .antMatchers("/api/user/index").hasRole("USER")
//                .antMatchers("/user/check").hasRole("ADMIN")
